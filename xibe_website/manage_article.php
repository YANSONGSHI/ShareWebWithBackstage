				...
				<div class="article_content">
					<div class="ac_top">
						<div class="ac_top_img">
							<img src="<?php echo $v['info_img'];?>" width="100%" height="330px"/>
						</div>
						
						<div class="ac_class">
							<p>
								<a href="#"><?php echo $v['info_class'];?></a>
					...
					<div class="ac_bottom">
						<div class="ac_left">
							...
							<!--</div>-->
							<div class="ac_title">
								<a href="#"><?php echo $v['info_title'];?></a>
							</div>
							<div class="ac_date">
								<p>
									<img src="images/com.png" width="26px" style="float: left;"/>
									<span style="padding: 0 16px;color: #999;font-size: 16px;">20</span>
								</p>
							</div>
					   ...
					   <div class="ct_info">
					       <div class="act_top">
						        <div class="act_top_left">
						            <img alt="管理员头像" src="images/head7.jpg" width="100px">
						            <span>管理人员</span>
						        </div>
						        <div class="act_top_right">
						            <h3>admin</h3>
						            <p>个人简介：<span>一只管理员</span></p>
						        </div>
						        <div class="f_clear"></div>
    						</div><!-- end act_top -->
					   </div><!-- end ct_info -->
