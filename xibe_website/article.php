			...
			<?php 
             ...
             ?>
				<div class="article_content">
					<div class="ac_left">
					   <div class="ac_back">
							<a href="community.php">文章列表 </a>
						</div>
						<div class="ac_title">
							<a href="#"><?php echo $v['art_title'];?></a>
						</div>
						<div class="ac_date">
							<p><?php echo $v['add_time']?></p>
						</div>
						<div class="f_clear"></div>
						<!--文章内容-->
						<div class="ac_con">
							<div class="ac_img">
								<img src="<?php echo $v['content_img'];?>" />
					   ...
					   <div class="ct_info">
					       <div class="act_top">
						        <div class="act_top_left">
						            <img alt="用户头像" src="images/head4.jpg" width="100px">
						            <span>普通用户</span>
						        </div>
						        <div class="act_top_right">
						            <h3><?php echo $v['user_name']?></h3>
						            <p>个人简介：<span>对个人简单的信息介绍内容位置</span></p>
						        </div>
						        <div class="f_clear"></div>
    						</div><!-- end act_top -->
					   </div><!-- end ct_info -->
