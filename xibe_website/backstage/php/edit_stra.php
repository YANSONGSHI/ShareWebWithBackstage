...
$Res = mysql_query("select * from strategy where id = '".$_REQUEST['id']."'");
$Row = mysql_fetch_assoc($Res);

if (!empty($_REQUEST['title']) && !empty($_REQUEST['author'])){
    $updateRes = mysql_query("update strategy set pro_tittle = '".trim($_REQUEST['title'])."', pro_introduce = '".trim($_REQUEST['author'])."' , pro_bg = 'images/".$_FILES["file"]["name"]."' where id = '".$_REQUEST['id']."'");
}
if (!empty($updateRes)){
    if ($updateRes==1){
        echo "
        <script language='javascript'>
            alert('修改成功');
            window.location.href='../stra_manage.php';
        </script>
      ";
    }
}
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../index.php">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="../stra_manage.php">首页攻略</a><span class="crumb-step">&gt;</span><span>修改攻略</span></div>
        </div>
...
<!--                                 </select> -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo $Row['pro_tittle'];?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>描述：</th>
                                <td><input class="common-text" name="author" size="50" value="<?php echo $Row['pro_introduce'];?>" type="text"></td>
                            </tr>
                            <tr>
