        ...
        <div class="top-info-wrap">
            ...
            <?php 
                ...
                if (isset($_SESSION['adname'])){
                    ...
                    echo "<li><a href='#'>管理员</a></li>"."<li><a href='pwd_manage.php'>修改密码</a></li>"."<li><a href='#'>退出</a></li>";
                }
            ?>
<!--                 <li><a href="#">管理员</a></li> -->
<!--                 <li><a href="pwd_manage.php">修改密码</a></li> -->
<!--                 <li><a href="#">退出</a></li> -->
            </ul>
        </div>
    </div>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>『喜碧』后台管理系统</span></div>
        </div>
